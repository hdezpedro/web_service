...
def insert_cliente(nombre,apellido_paterno,apellido_materno,telefono,email):
    try:
...
def edit_cliente(id_cliente,nombre,apellido_paterno,apellido_materno,telefono,email):
    try:
